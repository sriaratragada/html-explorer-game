...
export const LOCATIONS: Location[] = [
  ...
  { id: 'ironhold', name: 'Ironhold', type: 'castle', description: "A mountain castle carved from living rock. The Iron Compact's stronghold.", biome: 'Mountain Range', npcs: ['lord_vane', 'sergeant_kael'], connections: ['saltmoor', 'coldpeak', 'crossroads'], icon: '🏰' },
